 ...
 * @version V1.0.0
 */
public class AccountFreezeDetailResponse extends BussinessResponse {

	private static final long serialVersionUID = -4722506303388158455L;
	...
	public String toString() {
		return "AccountFreezeDetailResponse [systemCode=" + systemCode + ", bussinessCode=" + bussinessCode + ", transFlow=" + transFlow + ", freezeNo=" + freezeNo
