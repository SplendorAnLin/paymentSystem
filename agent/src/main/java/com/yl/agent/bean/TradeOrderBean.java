...
import com.yl.agent.enums.BusinessType;
import com.yl.agent.enums.OrderType;
import com.yl.agent.enums.PartnerRole;
import com.yl.agent.enums.RepeatFlag;
...
public class TradeOrderBean implements Serializable {
	...
	/** 手续费 **/
	private String receiverfeeStart;
	private String receiverfeeEnd;
	...
	public String getReceiverfeeStart() {
		return receiverfeeStart;
	}

	public void setReceiverfeeStart(String receiverfeeStart) {
		this.receiverfeeStart = receiverfeeStart;
	}

	public String getReceiverfeeEnd() {
		return receiverfeeEnd;
	}

	public void setReceiverfeeEnd(String receiverfeeEnd) {
		this.receiverfeeEnd = receiverfeeEnd;
	}
