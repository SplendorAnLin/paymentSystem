            ...
            <div class="fix">
              ...
              <div class="item">
                <div class="input-area">
                  ...
                  <div class="input-wrap">
                    <dict:select styleClass="input-select accountType" name="customer.customerType" shield="OEM" dictTypeId="AGENT_TYPE"></dict:select>
                  </div>
                </div>
              </div>
              <div class="item">
            ...
            <div class="fix">
              ...
              <div class="item">
                <div class="input-area">
                  ...
                  <div class="input-wrap">
                    <input type="text" class="input-text" name="customer.eMail" email requiredNot>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col fl">
            <div class="item">
              <div class="input-area">
                ...
                <div class="input-wrap">
                  <input type="text" class="input-text open-cate" name="customerCertBean.legalPerson" disabled required>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="input-area">
                ...
                <div class="input-wrap">
                  <input type="text" class="input-text open-cate" name="customerCertBean.enterpriseUrl" disabled required>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="input-area">
                ...
                <div class="input-wrap">
                  <input type="text" class="input-text open-cate" name="customerCertBean.consumerPhone" disabled required telPhone>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="input-area">
                ...
                <div class="input-wrap">
                  <input type="text" class="input-text open-cate" name="customerCertBean.icp" disabled required>
                </div>
              </div>
            </div>
          </div>
          <div class="col fl">
            <div class="item">
              <div class="input-area">
                ...
                <div class="input-wrap">
                  <input type="text" class="input-text open-cate" name="customerCertBean.businessScope" disabled required>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="input-area">
                ...
                <div class="input-wrap">
                  <input type="text" class="input-text open-cate" name="customerCertBean.enterpriseCode" disabled required>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="input-area">
                ...
                <div class="input-wrap">
                  <input type="text" class="input-text open-cate" name="customerCertBean.businessAddress" disabled required>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="input-area">
                ...
                <div class="input-wrap">
                  <input type="text" name="customerCertBean.validStartTime" date-fmt="yyyy-MM-dd" class="input-text double-input date-start" disabled required>
                </div>
                <span class="cut"> - </span>
                <div class="input-wrap">
                  <input type="text" name="customerCertBean.validEndTime" date-fmt="yyyy-MM-dd" class="input-text double-input date-end" disabled required>
                </div>
              </div>
            </div>
          </div>
