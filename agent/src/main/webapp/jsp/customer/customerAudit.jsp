...
<body style="width: 900px; padding:10px;">
  ...
  <form class="validator notification" action="auditCustomerAction.action" method="post" prompt="DropdownMessage"  data-success="操作成功" data-fail="操作失败" style="padding: 0.4em;">
    ...
    <input name="customer.customerType" type="hidden" value="${customer.customerType }" />
      ...
      <div class="content detail">
        ...
        <div class="col w-p-50">
          ...
          <div class="row">
            ...
            <span class="value color-orange"><dict:write dictId="${customer.status }" dictTypeId="CUSTOMER_STATUS_COLOR"></dict:write></span>
          </div>
          <div class="row">
      ...
      <div class="content">
        ...
        <div id="productWrap">
          ...
          <div class="productItem" data-productType="POS">
            ...
            <!-- 银行卡收单网店管理 -->
            <div class="shopMannage">
              <p class="mb-10">
                <span class="title ib">网点管理</span>
                <i class="addShop fa fa-plus-square"></i>
              </p>
              <div class="shopWrap" id="shopMannage">
              </div>
            </div>
          </div>
    ...
    <div class="row">
      ...
      <div class="content">
        <div class="textarea-box">
          <textarea name="custMsg" class="w-p-100" style="height: 100px;"></textarea>
        </div>
      </div>
    </div>
