...
<%		
	...
	response.addHeader("Content-Disposition", "attachment; filename="+java.net.URLEncoder.encode("提现记录", "utf8")+"-"+ com.pay.common.util.DateUtil.formatDate(new Date(), "yyyy-MM-dd")+".xls");
