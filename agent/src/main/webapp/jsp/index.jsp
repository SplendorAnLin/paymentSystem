...
<body class="full-size over-hide">
  ...
  <div class="sys-header theme-bg absolute">
    ...
    <div class="fr">
      <ul class="links fl">
        <li><a target="_blank" href="javascript:void(0);">聚合服务商管理系统</a></li>
      ...
      <div class="control-panel fl">
        ...
        <div class="menus theme-bg">
          ...
          <a class="theme-bg-hover" href="javascript:void(0);" data-title="账户信息" data-create="${pageContext.request.contextPath}/queryAgentBasicInfo.action" >账户信息</a>
