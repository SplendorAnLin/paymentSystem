        ...
        <div class="adaptive fix">
          ...
          <div class="item">
            <div class="input-area">
              ...
              <div class="input-wrap">
                <dict:select nullOption="true" styleClass="input-select" dictTypeId="ACCOUNT_CARD" name="acc_no_type">></dict:select>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="input-area">
              ...
              <div class="input-wrap">
                <dict:select nullOption="true" name="certificates_type" styleClass="input-select" dictTypeId="TYPE_OF_CERTIFICATE"></dict:select>
              </div>
            </div>
          </div>
          <div class="item">
          ...
          <div class="item">
            <div class="input-area">
              ...
              <div class="input-wrap">
                <dict:select styleClass="input-select" name="order_status" nullOption="true" dictTypeId="ORDER_STATUS"></dict:select>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="input-area">
              ...
              <div class="input-wrap">
                <dict:select nullOption="true" styleClass="input-select" name="clear_status" dictTypeId="RECEIVE_ORDER_STATUS"></dict:select>
              </div>
            </div>
          </div>
          <div class="item">
          ...
          <div class="item">
            <div class="input-area">
              ...
              <div class="input-wrap">
                <input type="text" name="create_time_start" class="input-text double-input default-date date-start" date-fmt="yyyy-MM-dd">
              </div>
              <span class="cut"> - </span>
              <div class="input-wrap">
                <input type="text" name="create_time_end" class="input-text double-input default-date-end date-end" date-fmt="yyyy-MM-dd">
              </div>
            </div>
          </div>
          <div class="item">
            <div class="input-area">
              ...
              <div class="input-wrap">
                <input type="text" name="last_update_time_start" class="input-text double-input default-date date-start" date-fmt="yyyy-MM-dd">
              </div>
              <span class="cut"> - </span>
              <div class="input-wrap">
                <input type="text" name="last_update_time_end" class="input-text double-input default-date-end date-end" date-fmt="yyyy-MM-dd">
              </div>
            </div>
          </div>
        </div>
