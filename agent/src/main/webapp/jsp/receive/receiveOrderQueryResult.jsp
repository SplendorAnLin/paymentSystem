          ...
          <table class="data-table shadow--2dp  w-p-100 tow-color">
            ...
            <tbody>
              <vlh:row bean="defConfig">
                ...
                <vlh:column property="acc_type" attributes="width='8%'"><dict:write dictId="${entity.acc_type }" dictTypeId="ACCOUNT_TYPE"></dict:write>  </vlh:column>
                <vlh:column property="acc_no_type" attributes="width='8%'"><dict:write dictId="${entity.acc_no_type }" dictTypeId="ACCOUNT_CARD"></dict:write></vlh:column>
                <vlh:column property="amount" attributes="width='10%'"/>
                <vlh:column property="fee" attributes="width='10%'"/>
                <vlh:column property="certificates_type" attributes="width='8%'"><dict:write dictId="${entity.certificates_type }" dictTypeId="TYPE_OF_CERTIFICATE"></dict:write></vlh:column>
                <vlh:column property="certificates_code" attributes="width='10%'"/>
                <vlh:column attributes="width='8%'"><dict:write dictId="${entity.order_status }" dictTypeId="ORDER_STATUS_COLOR"></dict:write></vlh:column>
                <vlh:column attributes="width='8%'"><dict:write dictId="${entity.clear_status }" dictTypeId="RECEIVE_ORDER_STATUS_COLOR"></dict:write></vlh:column>
