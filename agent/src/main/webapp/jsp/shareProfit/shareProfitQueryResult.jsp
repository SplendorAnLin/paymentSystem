          ...
          <table class="data-table shadow--2dp  w-p-100 tow-color">
            ...
            <tbody>
              <vlh:row bean="shareProfit">
                ...
                <vlh:column attributes="width='80px'"><dict:write dictId="${entity.source }" dictTypeId="ORDER_SOURCE"></dict:write></vlh:column>
                ...
                <vlh:column property="direct_agent_profit" attributes="width='100px'" />
                <vlh:column attributes="width='80px'" property="indirect_agent_profit" />
