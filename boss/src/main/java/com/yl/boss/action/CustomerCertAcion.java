 ...
 * @version V1.0.0
 */
public class CustomerCertAcion extends Struts2ActionSupport{

	private static final long serialVersionUID = -4337044170794670550L;
	...
	static {
		try {
			...
			logger.error("CustomerCertAcion load Properties error:", e);
		}
	}
	...
	public String update(){
		...
		try {
			...
			if(StringUtil.isNull(msg)){
				String imgPath = "bc-" + customerCert.getCustomerNo() + "-" + Long.toHexString(System.nanoTime()) + ".jpg";
			...
			if(StringUtil.isNull(msg)){
				String imgPath = "tc-" + customerCert.getCustomerNo() + "-" + Long.toHexString(System.nanoTime()) + ".jpg";
			...
			if(StringUtil.isNull(msg)){
				String imgPath = "oc-" + customerCert.getCustomerNo() + "-" + Long.toHexString(System.nanoTime()) + ".jpg";
			...
			if(StringUtil.isNull(msg)){
				String imgPath = "ac-" + customerCert.getCustomerNo() + "-" + Long.toHexString(System.nanoTime()) + ".jpg";
			...
			customerCertService.update(customerCert, auth.getRealname());
		} catch (Exception e) {
			throw new RuntimeException("update customerCert:["+customerCert.getCustomerNo()+"] is failed! exception:{}", e);
		}
		return SUCCESS;
	}
