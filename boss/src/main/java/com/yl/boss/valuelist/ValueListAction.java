...
import com.yl.boss.action.Struts2ActionSupport;
...
public class ValueListAction extends Struts2ActionSupport {
	...
	public String execute(){
		...
		if(auth != null){
			requestParam.put("ownerId", auth.getCustomerno());
			requestParam.put("customerNo", auth.getCustomerno());
		}
