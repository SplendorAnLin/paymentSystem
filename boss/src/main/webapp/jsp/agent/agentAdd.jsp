...
<body style="min-width: 810px; padding:0.2em;">
  ...
  <form class="validator" id="agentAdd" method="post" enctype="multipart/form-data" action="openAgentAction.action" prompt="DropdownMessage"  style="padding: 0.4em;">
            ...
            <div class="fix">
              <div class="item">
                <div class="input-area">
                  ...
                  <div class="input-wrap">
                    <dict:select styleClass="input-select accountType" diy='id="customer_customerType"' shield="OEM"  name="agent.agentType" dictTypeId="AGENT_TYPE"></dict:select>
                  </div>
                </div>
              </div>
              <div class="item">
              ...
              <div class="item">
                <div class="input-area">
                  ...
                  <div class="input-wrap">
                    <input type="text" class="input-text" name="agent.eMail" email required>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col fl">
            ...
            <div class="item">
              <div class="input-area">
                ...
                <div class="input-wrap">
                  <input type="text" class="input-text open-cate" name="agentCert.enterpriseUrl" disabled required>
                </div>
              </div>
            </div>
            <div class="item">
            ...
            <div class="item">
              <div class="input-area">
                ...
                <div class="input-wrap">
                  <input type="text" class="input-text open-cate" name="agentCert.icp" disabled required>
                </div>
              </div>
            </div>
          </div>
