...
<body>
  ...
  <div class="query-box">
    ...
    <div class="query-form mt-10">
      <form action="dfAuditQuery.action" method="post" target="query-result">
        <input type="hidden" name="auditStatus" value="REMIT_WAIT">
        <div class="adaptive fix">
          ...
          <div class="item">
            <div class="input-area">
              ...
              <div class="input-wrap">
                <input type="text" name="auditDate1" class="input-text default-time double-input date-start ignoreEmpy">
              </div>
              <span class="cut"> - </span>
              <div class="input-wrap">
                <input type="text" name="auditDate2" class="input-text default-time-end double-input date-end ignoreEmpy">
              </div>
            </div>
          </div>
        </div>
  ...
  <script>
    ...
    $('#show_viewCount').data('sumFn', function(data, viewCount) {
      ...
      $('.sum-cost', viewCount).text(utils.toFixed(result[2]) || 0);
    });
  </script>
</body>
</html>
