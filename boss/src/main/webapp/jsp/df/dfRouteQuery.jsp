...
<body>
  ...
  <div class="query-box">
    ...
    <div class="query-form mt-10">
      <form action="${pageContext.request.contextPath}/dfRouteQuery.action" method="post" target="query-result">
        <div class="adaptive fix">
          ...
          <div class="item">
            <div class="input-area">
              ...
              <div class="input-wrap">
                <dict:select nullOption="true" styleClass="input-select" dictTypeId="INTERFACE_TYPE" name="interfaceType"></dict:select>
              </div>
            </div>
          </div>
          --%>
        ...
        <div class="text-center mt-10">
          ...
          <a data-myiframe='{
                "target": "${pageContext.request.contextPath}/dfRouteQueryDictionary.action",
                "btns": [
                  {"lable": "取消"},
