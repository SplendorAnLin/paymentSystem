...
<body>
  ...
  <form id="modifyForm" class="validator notification text-center" action="agentModifyMenu.action" method="post" prompt="message"  data-success="修改成功" data-fail="修改失败" style="padding: 2em 0.4em 0.4em;">
  ...
  <div class="not-ready-render" id="add-subMenu-wrap" style="width: 360px; padding: 10px;display: none;">
    <form class="validator notification" action="agentAddChildMenu.action" method="post" prompt="DropdownMessage"  data-success="新增成功" data-fail="新增失败">
