...
<body>
  ...
  <form id="modifyForm" class="validator notification text-center" action="modifyMenu.action" method="post" prompt="message"  data-success="修改成功" data-fail="修改失败" style="padding: 2em 0.4em 0.4em;">
    ...
    <div class="fix">
      ...
      <div class="col fl w-p-50">
        <div class="fix">
          ...
          <div class="item">
            <div class="input-area">
              <span class="label w-100">所属上级菜单:</span>
              <div class="input-wrap">
  ...
  <div class="not-ready-render" id="add-subMenu-wrap" style="width: 360px; padding: 10px;display: none;">
    <form class="validator notification" action="addChildMenu.action" method="post" prompt="DropdownMessage"  data-success="新增成功" data-fail="新增失败">
