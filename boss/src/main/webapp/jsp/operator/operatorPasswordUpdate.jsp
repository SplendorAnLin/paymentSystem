...
<body style="width: 378px; padding: 0.2em;">
  ...
  <div class="query-box" style="padding: 0.8em 3em;">
    ...
    <div class="query-form">
      <form class="validator ajaxFormNotification" action="passwordUpdateAction.action" method="post" prompt="DropdownMessage" data-success="修改密码成功" data-fail="修改密码失败" >
    ...
    form.data('receiver-hook', function(msg, closeDialog) {
        switch(msg) {
          case 'true':
            ...
            break;
          case 'false':
            closeDialog(false, '修改密码失败! 原密码错误!');
            break;
          default:
