...
<body>
        ...
        <div class="adaptive fix">
          ...
          <div class="item">
            <div class="input-area">
              ...
              <div class="input-wrap">
                <input type="text" name="complete_time_start" class="input-text double-input date-start default-time ignoreEmpy">
              </div>
              <span class="cut"> - </span>
              <div class="input-wrap">
                <input type="text" name="complete_time_end" class="input-text double-input date-end default-time-end ignoreEmpy">
              </div>
            </div>
          </div>
  ...
  <script>
    ...
    $('#show_viewCount').data('sumFn', function(data, viewCount) {
      ...
      $('.sum-fee', viewCount).text(utils.toFixed(result.cf) || 0);
      $('.sum-cost', viewCount).text(utils.toFixed(result.bc) || 0);
    });
  </script>
</body>
</html>
