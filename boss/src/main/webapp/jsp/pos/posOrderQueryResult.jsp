...
<body class="pb-2">
  ...
  <div class="title-h1 fix">
    ...
    <a class="fr" href="javascript:void(0);" data-exprot="${pageContext.request.contextPath}/posOrderQueryExport.action">导出</a>
  </div>
	        ...
	        <table class="data-table shadow--2dp  w-p-100 tow-color">
	          ...
	          <tbody>
				<vlh:row bean="orderQuery">
					...
					<vlh:column property="status"><dict:write dictId="${order.status }" dictTypeId="POS_ORDER_STATUS"></dict:write></vlh:column>
					<vlh:column property="credit_status" ><dict:write dictId="${order.credit_status }" dictTypeId="CREDIT_STATUS_COLOR"></dict:write></vlh:column>
