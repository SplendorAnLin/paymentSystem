...
<body style="width: 1053px;padding:0.2em;">
  ...
  <form class="validator notification" style="padding: 1em;" action="${pageContext.request.contextPath}/receiveRouteAdd.action" method="post" id="form" prompt="DropdownMessage"  data-success="新增成功" data-fail="新增失败">
          ...
          <div class="adaptive fix">
            <div class="item">
              <div class="input-area">
                ...
                <div class="input-wrap">
                  <input type="text" class="input-text" name="routeConfigBean.code"  required notChinese checkReceiverRouter trigger='{"checkReceiverRouter": 2}'>
                </div>
              </div>
            </div>
            <div class="item">
            ...
            <div class="item">
              <div class="input-area">
                ...
                <div class="input-wrap">
                  <dict:select name="routeConfigBean.status" styleClass="input-select" dictTypeId="ACCOUNT_STATUS"></dict:select>
                </div>
              </div>
            </div>
          </div>
  ...
  <script>
    ...
    // 检测路由是否重复
    Compared.add('checkReceiverRouter', function(val, params, ele, ansyFn) {
    	Api.boss.checkReceiverRouter(val, function(status) {
    		ansyFn(Compared.toStatus(status, '路由编码重复!'));
    	});
    })
    // 查询代收接口信息, 并填入下拉列表
