          ...
          <table class="data-table shadow--2dp  w-p-100 tow-color">
            ...
            <tbody>
              <vlh:row bean="defConfig">
                ...
                <vlh:column property="status" attributes="width='8%'">
                <dict:write dictId="${entity.status }" dictTypeId="ACCOUNT_STATUS_COLOR"></dict:write>
                </vlh:column>
                <td>
                  <button data-myiframe='{
                    "target": "${pageContext.request.contextPath}/receiveRouteQueryByCode.action?routeConfigBean.code=${entity.code }&operate=update",
                    "btns": [
                      {"lable": "取消"},
                      {"lable": "修改", "trigger": ".btn-submit"}
                    ]
                  }' class="btn-small">修改</button>
                  <button data-dialog="${pageContext.request.contextPath}/receiveRouteQueryByCode.action?routeConfigBean.code=${entity.code }&operate=detail" class="btn-small">详情</button>
                </td>
              </vlh:row>
            </tbody>
          </table>
