...
<body style="width: 1400px;  padding: 10px;">
  ...
  <form class="validator ajaxFormNotification" action="protocolManagementUpdate.action" method="post" prompt="DropdownMessage"  data-success="修改成功" data-fail="修改失败">
    <input type="hidden" name="protocolManagement.id" value="${protocolManagement.id }">
    <!-- 基本信息 -->
    <div class="row">
              ...
              <div class="item">
                <div class="input-area">
                  ...
                  <div class="input-wrap">
                    <input type="text" class="input-text" name="protocolManagement.title" value="${protocolManagement.title }" required>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="input-area">
                  ...
                  <div class="input-wrap">
                    <dict:select styleClass="input-select" name="protocolManagement.status" dictTypeId="ALL_STATUS" value="${protocolManagement.status }"></dict:select>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="fix">
              <div class="item">
                <div class="input-area">
                  ...
                  <div class="input-wrap">
                    <dict:select styleClass="input-select" name="protocolManagement.type" value="${protocolManagement.type }" onchange="changeDocType(this.value);" dictTypeId="PROTOCOL_MANAGEMENT"></dict:select>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="input-area">
                  ...
                  <div class="input-wrap">
                    <!--隐藏下拉列表-->
                    <dict:select diy=" dataType=\"PACT\"" value="${protocolManagement.sort }" style="display:none;" dictTypeId="PROTOCOL_MANAGEMENT_PACT"></dict:select>
                    <dict:select diy=" dataType=\"HELP\""  value="${protocolManagement.sort }" style="display:none;" dictTypeId="PROTOCOL_MANAGEMENT_HELP"></dict:select>
                    <!--实际下拉列表-->
                    <select class="input-select" name="protocolManagement.sort" data-value="${protocolManagement.sort }" id="target" required>
                    </select>
                  </div>
                </div>
              </div>
  ...
  <script>
    ...
    window.DialogLoad = function() {
      ...
      editor.ready(function () {
        // 编辑页面, 初始化值到编辑器内
        editor.setContent('${protocolManagement.content }');
