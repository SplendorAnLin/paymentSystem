...
<body style="width: 540px; padding:0.2em;">
  ...
  <div class="query-box" style="padding: 1.8em 3em;">
    ...
    <div class="query-form">
      <form class="validator notification" action="agentSettlementUpdate.action" method="post" id="form" prompt="DropdownMessage"  data-success="修改成功" data-fail="修改失败">
        <input type="hidden" name="agentSettle.bankCode" value="${agentSettle.bankCode }" id="bankCode">
          ...
          <div class="item">
            <div class="input-area">
              ...
              <div class="input-wrap">
                <input type="text" name="agentSettle.agentNo" class="input-text" value="${agentSettle.agentNo }" readonly>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="input-area">
              ...
              <div class="input-wrap">
                <input type="text" name="agentSettle.accountName" id="cardName" class="input-text" value="${agentSettle.accountName}" required>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="input-area">
              ...
              <div class="input-wrap">
                <dict:select styleClass="input-select" value="${agentSettle.agentType }" id="accType" name="agentSettle.agentType" dictTypeId="ACCOUNT_TYPE"></dict:select>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="input-area">
              ...
              <div class="input-wrap">
                <input type="text" name="agentSettle.accountNo" id="accountNo" class="input-text" value="${agentSettle.accountNo }"" required>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="input-area">
              ...
              <div class="input-wrap mr-10">
                <input type="text" class="input-text" style="width: 280px;" name="agentSettle.openBankName" id="openBankName" value="${agentSettle.openBankName}" placeholder="请输入地区、分行支行名称等关键词进行匹配" required>
              </div>
