...
<body>
  ...
  <div class="query-box">
    ...
    <div class="query-form mt-10">
      <form action="customerSettleQuery.action" method="post" target="query-result">
        <div class="adaptive fix">
          ...
          <div class="item">
            <div class="input-area">
              ...
              <div class="input-wrap">
                <dict:select nullOption="true" styleClass="input-select" name="customer_type" dictTypeId="ACCOUNT_TYPE"></dict:select>
              </div>
            </div>
          </div>
          <div class="item">
