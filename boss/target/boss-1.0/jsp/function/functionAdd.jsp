...
<body style="width: 430px; padding:0.2em;">
  ...
  <div class="query-box" style="padding: 0.8em 0;">
    ...
    <div class="query-form">
      <form class="validator notification" action="functionAdd.action" method="post" prompt="DropdownMessage"  data-success="新增成功" data-fail="新增失败">
        ...
        <div class="fix">
          ...
          <div class="item">
            <div class="input-area">
              ...
              <div class="input-wrap">
                <dict:select styleClass="input-select" name="function.isCheck" dictTypeId="YNY"></dict:select>
