...
<body class="full-size over-hide">
  ...
  <div class="sys-header theme-bg absolute">
    ...
    <div class="fr">
      <ul class="links fl">
        <li><a target="_blank" href="javascript:void(0);">聚合支付运营管理系统</a></li>
      ...
      <div class="control-panel fl">
        ...
        <div class="menus theme-bg">
          ...
          <a class="theme-bg-hover" href="javascript:void(0);" data-myiframe='{
            "target": "toOperatorPasswordUpdate.action",
            "btns": [
              {
                "lable": "取消"
              },
          ...
          <a class="theme-bg-hover" data-myiframe='{
            "target": "toOperatorAuditPasswordUpdate.action",
            "btns": [
              {
                "lable": "取消"
              },
            ...
            "drag": true,
            "isModal": true
            }' href="javascript:void(0);">修改审核密码</a>
