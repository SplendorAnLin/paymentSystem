...
<%
	...
	response.addHeader("Content-Disposition", "attachment; filename=orderInfo.xls");
	...
	<c:if test="${order != null && order.size() > 0 }">
		<table cellpadding="1" cellspacing="1" align="center" class="global_tableresult" style="width: 100%">
			<tr>
				...
				<td width="80px;">收款方</td>
				<td width="50px;">订单金额</td>
				<td width="50px;">收款方手续费</td>
				<td width="50px;">交易成本</td>
			...
			<c:forEach items="${order}" var="ords" varStatus="i">
				<tr>
					...
					<td><fmt:formatNumber value="${ords.cost }" pattern="#.##"/></td>
					<td>
