...
<body style="width: 1400px;padding: 10px;">
  ...
  <div class="row">
    <div class="title-h1 fix tabSwitch2">
      <span class="primary fl">POS交易基本信息</span>
    </div>
    <div class="content">
      <div class="table-info w-p-100">
        <div class="type-table fl w-p-50">
          ...
          <div class="type-tr">
            <div class="type-td w-100 text-primary">商户流水号</div>
  ...
  <div class="row mt-10">
    <div class="title-h1 fix tabSwitch2">
      <span class="primary fl">POS交易订单流水</span>
    </div>
    <div class="content">
            ...
            <tbody>
              <c:forEach items="${order.list }" var="pay">
                <tr>
                  ...
                  <td>POS收单</td>
                  <td>${pay.amount+pay.customerFee }</td>
