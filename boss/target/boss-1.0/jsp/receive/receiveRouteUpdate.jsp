...
<body style="width: 1053px;padding:0.2em;">
  ...
  <form class="validator notification" style="padding: 1em;" action="${pageContext.request.contextPath}/receiveRouteUpdate.action" method="post" id="form" prompt="DropdownMessage"  data-success="新增成功" data-fail="新增失败">
          ...
          <div class="adaptive fix">
            ...
            <div class="item">
              <div class="input-area">
                ...
                <div class="input-wrap">
                  <input type="text" class="input-text" name="routeConfigBean.name"  value="${routeConfigBean.name }" disabled="disabled">
                </div>
              </div>
            </div>
            <div class="item">
              <div class="input-area">
                ...
                <div class="input-wrap">
                  <input type="text" class="input-text" name="routeConfigBean.routeInfo.priority"  disabled="disabled" value="${routeConfigBean.routeInfo.priority }" >
                </div>
              </div>
            </div>
            <div class="item">
              <div class="input-area">
                ...
                <div class="input-wrap">
                  <select class="input-select" name="routeConfigBean.routeInfo.remitCode" data-defaultValue="${routeConfigBean.routeInfo.remitCode }">
                  </select>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="input-area">
                ...
                <div class="input-wrap">
                  <dict:select value="${routeConfigBean.status }" name="routeConfigBean.status" styleClass="input-select" dictTypeId="ACCOUNT_STATUS"></dict:select>
                </div>
              </div>
            </div>
          </div>
                ...
                <c:if test="${map.key == 'bankCodeList' }">
                  <c:forEach items="${map.value }" var="m">
                    <div class="checkbox-wrap">
                      <input type="checkbox" value="${fn:split(m.key,".")[1] }" name="routeConfigBean.routeInfo.bankCodes" class="checkbox" 
