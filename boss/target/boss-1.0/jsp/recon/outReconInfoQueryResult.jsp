          ...
          <tr>
            ...
            <td>
              <c:choose>
                ...
                <c:otherwise><a class="color-red"
                                data-dialog="${pageContext.request.contextPath}/findReconInfo.action?reconException.reconOrderId=${rec.code}&reconException.reconExceptionType=BANK"
