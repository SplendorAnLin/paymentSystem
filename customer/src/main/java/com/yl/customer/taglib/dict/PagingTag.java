 ...
 */
package com.yl.customer.taglib.dict;
 ...
 * @version V1.0.0
 */
public class PagingTag extends ConfigurableTag
{

   /**
	 * 
	 */
	private static final long serialVersionUID = -6566573604006578772L;
...
/**
   ...
   public int doEndTag() throws JspException
   {
      ...
      if (getBodyContent() == null || getBodyContent().getString() == null || getBodyContent().getString().trim().length() == 0)
      {
         ...
         //跳转维持功能
         parameters.put(ValueListInfo.PAGING_PAGE + tableInfo.getId(), String.valueOf(1));
         sb.append("\n     <td class=\"hidden\" id=\"JUMP_LINK\">");
         renderPagingLink(sb, parameters, "1");
         sb.append("</td>");
      }
      ...
      if (showSummary)
      {
         sb.append("</td>");
         sb.append("<td>");
         sb.append("<span class=\"ml-20\"><span class=\"plr-5\" style=\"line-height: 30px;\">转至</span><span class=\"input-wrap\"> ");
         sb.append("<input class=\"input-text\" id=\"JUMP_INPUT\" type=\"number\" placeholder=\"1\" value=\"1\" min=\"1\" max=\"999\"> ");
         sb.append("<span id=\"JUMP_BTN\" class=\"jump-btn btn-1\"><a name=\"jump\" href=\"javascript:void(0);\"><i class=\"fa-share fa\"></i></a></span>");
         sb.append("</span><span class=\"plr-5\">页</span></span>");
         sb.append("</td>");
         sb.append("\n </tr>");
         sb.append("\n</table>");
      }
