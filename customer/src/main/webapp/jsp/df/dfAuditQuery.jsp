...
<body>
  ...
  <div class="query-box">
    ...
    <div class="query-form mt-10">
      <form action="dfAuditQuery.action" method="post" target="query-result">
        <input type="hidden" name="auditStatus" value="WAIT">
        <div class="adaptive fix">
          ...
          <div class="item">
            <div class="input-area">
              ...
              <div class="input-wrap">
                <dict:select nullOption="true" styleClass="input-select" name="accountType" dictTypeId="LIQUIDATION_STATUS"></dict:select>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="input-area">
              ...
              <div class="input-wrap">
                <input type="text" name="applyDate1" class="input-text double-input date-start">
              </div>
              <span class="cut"> - </span>
              <div class="input-wrap">
                <input type="text" name="applyDate2" class="input-text double-input date-end">
              </div>
            </div>
          </div>
        </div>
