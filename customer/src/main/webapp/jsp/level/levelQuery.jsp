...
<div class="w-p-100 min-width">
	<div class="form-box mb-40 mt-20 ml-20">
		<form class="rest-from" action="toLevelQueryList.action" method="post" target="queryResult" id="form">
			...
			<div style="margin-left: 372px;">
				...
				<button class="btn pop-modal btn-loading" data-title="新增级别" data-url="toLevelAdd.action" >新增级别</button>
			</div>
		</form>
	</div>
