...
<body class="over-y-h">
	<div class="in-pop" style="width: 400px;padding: 20px 0;">
		<form action="updateInterfaceProvider.action" method="post" id="updateform" target="Result" >
<div class="block">
	                 <span class="lable w-145">风险编号:</span>
	                 <div class="b-input w-170">
	                     <div class="input-wrap w-p-100">
	                         <input name="interfaceProvider.code" id="code" required notChinese type="text" class="input-text" disabled="disabled">
	                     </div>
	                 </div>
	             </div>
	             <div class="block">
	                 ...
	                 <div class="b-input w-170">
	                     <div class="input-wrap w-p-100">
	                         <input name="interfaceProvider.fullName" id="fullname" required type="text" class="input-text" disabled="disabled">
	                     </div>
	                 </div>
	             </div>
	             <div class="block">
