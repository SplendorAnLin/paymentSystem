 ...
 */
@Configuration
@Import({ MariaDBConfig.class, HessianServerConfig.class, HessianClientConfig.class, MyBatisConfig.class, ConsumerConfig.class, CacheConfig.class,ProducerClientConfig.class })
