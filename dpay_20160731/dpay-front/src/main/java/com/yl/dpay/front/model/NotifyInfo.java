...
public class NotifyInfo implements Serializable {
	...
	public String toString() {
		return "NotifyInfo [customerOrderId=" + customerOrderId + ", dpayOrderId=" + dpayOrderId + ", responseCode=" + responseCode + ", responseMsg=" + responseMsg
				+ ", orderTime=" + orderTime + ", amount=" + amount + ", fee=" + fee + ", customerParam=" + customerParam + "]";
	}
	...
	public String toJsonString() {
		...
		jsonStringer.key("customerParam");
		jsonStringer.value(customerParam);
	...
	public NotifyInfo(NotifyParams notifyParams) {
		super();
		this.customerOrderId = notifyParams.getCustomerOrderId();
		this.dpayOrderId = notifyParams.getDpayOrderId();
		this.responseCode = notifyParams.getResponseCode();
		this.responseMsg = notifyParams.getResponseMsg();
		this.orderTime = notifyParams.getOrderTime();
		this.amount = notifyParams.getAmount();
		this.fee = notifyParams.getFee();
		this.customerParam = notifyParams.getCustomerParam();
	}
