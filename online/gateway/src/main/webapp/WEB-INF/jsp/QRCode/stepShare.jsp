...
<body class="bc-lightGray">
	<div class="mobileFrame">
		...
		<form:form class="validator" action="${applicationScope.staticFilesHost}/gateway/share" method="POST" >
			<input type="hidden" name="cardNo" value="${cardNo }" >
			<input type="hidden" name="checkCode" value="${checkCode }" >
			<input type="hidden" name="passWord" value="${agentNo }" >
			<input type="hidden" name="publicPWD" value="share" >
			<div class="input-row">
				<div class="in row">
			...
			<div class="input-row">
				<div class="in row">
					<label class="col-3">推荐人编号:</label> <input class="col-9" readonly="readonly" type="text" value="${agentNo }" >
				</div>
			</div>
			<div class="btnWrap">
