...
<head>
    ...
    <script type="text/javascript">
        ...
        function queryOrder() {
            $.post("queryWalletOrder.htm","partnerCode="+$("#customerNo").val()+"&requestCode="+$("#outOrderId").val(),function(result){
                ...
                if (result != null && result != '' && result.code == '00') {
                    ...
                    setTimeout(function(){
                        window.location.href = "callback/wechatNative.htm?orderCode="+ $("#orderCode").val();
                    }, 3000);
                } else {
...
<div class="b-out mtb-40 w-950">
    <div class="b-in">
        ...
        <div class="order-box">
            ...
            <input id="content" value="${result.params.code_url}" type="hidden"/>
