...
(function() {
  // 生成省份options
  function provincesOption() {
    var options = $();
    $.each(provinces.provincesList, function() {
      var provin = this;
      var option = $('<option value="' + provin.Name + '">' + provin.Name + '</option>');
      option.data('citys', cityOptions(provin.Citys));
      options = options.add(option);
    });
    return options;
  }
  // 生成城市options
  function cityOptions(citys) {
    var options = $();
    $.each(citys, function() {
      var city = this;
