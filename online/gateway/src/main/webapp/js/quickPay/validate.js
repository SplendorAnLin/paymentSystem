	...
	return {
		...
		verification: function() {
			var algorithm = {
					...
					idnumber: function(value, filed, fill, errorMsg) {
						value = $.trim(value);
						var myAlgorithm = function() {
							return algorithm.__isFalse(function() {
					...
					phone: function(value, filed, fill, errorMsg) {
						value = $.trim(value);
						var myAlgorithm = function() {
							return algorithm.__isFalse(function() {
					...
					tel: function(value, filed, fill, errorMsg) {
						value = $.trim(value);
						var myAlgorithm = function() {
							return algorithm.__isFalse(function() {
				...
				strategies = {
					...
					tel: function(value, filed, fill, errorMsg) {
						return algorithm.tel(value, filed, fill, errorMsg);
					},
					phone: function(value, filed, fill, errorMsg) {
						return algorithm.phone(value, filed, fill, errorMsg);
					},
					idnumber: function(value, filed, fill, errorMsg) {
						return algorithm.idnumber(value, filed, fill, errorMsg);
					},
					isNumber: function(value, filed, fill, errorMsg) {
		...
		domclick: function(verificationFunc, formObj) {
			var form = formObj.form;
			console.log(formObj);
			if(typeof formObj.submitBeforeFn !== 'undefined' && typeof formObj.submitBeforeFn == 'function') {
				formObj.submitBeforeFn();
