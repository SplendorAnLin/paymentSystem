 ...
 * @version V1.0.0
 */
public class TestPartnerQueryRequestControllerTest extends BaseTest {
	private static final Logger logger = LoggerFactory.getLogger(TestPartnerQueryRequestControllerTest.class);
	@Test
	public void testReceivePayRequest() {
	...
	private static Map partnerQueryRequest() {
		...
		// 合作方订单编号
		String outOrderId = "5626402122404259";
		// 签名方式
		String signType = "MD5";
