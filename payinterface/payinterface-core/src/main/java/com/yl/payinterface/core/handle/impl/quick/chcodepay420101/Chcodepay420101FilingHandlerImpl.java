...
@Service("chcodepay420101FilingHandler")
public class Chcodepay420101FilingHandlerImpl implements QuickPayFilingHandler {

    private static Logger logger = LoggerFactory.getLogger(Chcodepay420101FilingHandlerImpl.class);
	...
	public Map<String, String> filing(Map<String, String> map) {
        ...
        try {
            ...
            // 查看当前结算卡是否支持
            if(properties.getProperty(map.get("bankCode")) == null || properties.getProperty(map.get("bankCode")).equals("")) {
            	return rtMap;
            }
            ...
            if(map.get("updateFlag").equals("0")) {
                ...
                reqMap.put("bank_name", map.get("bankName"));
                reqMap.put("bank_sub_name", map.get("bankName"));
