package com.yl.payinterface.core.handle.impl.quick.pengrui100101.utils;
 ...
 * @since 2017/12/6
 */
public class PengRui100101Utils {

    private static Logger logger = LoggerFactory.getLogger(PengRui100101Utils.class);
    ...
    public static JSONObject execute(String key, String url, String api, String dataJson, String partnerNo, String orderId) {
        ...
        try {
            ...
            params.put("encryptData", encode(PengRui100101AESUtils.encode(dataJson, dataKey)));
            ...
            String result = PengRui100101AESUtils.decode(decode(res.getString("encryptData")), dataKey);
