 ...
 */
@Service("quickUnionPay120001Handler")
public class UnionPay120001HandlerImpl implements QuickPayHandler, BindCardHandler, QuickPayOpenCardHandler {
	
	private static final String interfaceInfoCode = "QUICKPAY_UnionPay-120001";
	
	private static Logger logger = LoggerFactory.getLogger(UnionPay120001HandlerImpl.class);
	...
	@Resource
	private QuickPayFilingHandler unionPay120001FilingHandler;
	@Resource
	...
	public Map<String, String> bindCard(Map<String, String> params) {
		...
		if (filingInfo == null) {
			...
			Map<String, String> rtMap = unionPay120001FilingHandler.filing(params);
