package com.yl.payinterface.core.handle.impl.remit.hfb100004;
...
import com.yl.payinterface.core.handle.impl.remit.hfb100004.utils.CertUtil;
import com.yl.payinterface.core.handle.impl.remit.hfb100004.utils.Httpz;
import com.yl.payinterface.core.handle.impl.remit.hfb100004.utils.ParamUtil;
 ...
 * @since 2018/3/22
 */
@Service("remitHfb100004Handler")
public class Hfb100004HandlerImpl implements RemitHandler {

    private static final Logger logger = LoggerFactory.getLogger(Hfb100004HandlerImpl.class);
