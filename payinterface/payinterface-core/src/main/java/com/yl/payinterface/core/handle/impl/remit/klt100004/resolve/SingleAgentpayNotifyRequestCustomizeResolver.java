...
import com.yl.payinterface.core.handle.impl.remit.klt100004.single.dto.impl.response.agentPay.NotifyBody;
 ...
 * @since 2018/4/3
 */
public class SingleAgentpayNotifyRequestCustomizeResolver implements ICustomizeResolver {
	...
	public void doCustomizeResolve(XStream xStream) throws SinglepayResolveException {
		...
		xStream.alias("body", IBody.class,NotifyBody.class);
