package com.yl.payinterface.core.handle.impl.remit.reapal120000;
 ...
 * @version V1.0.0
 */
@Service("reapalHandler584001")
public class Reapal120000HandlerImpl implements RemitHandler,ChannelRecionHandler {

	private static Logger logger = LoggerFactory.getLogger(Reapal120000HandlerImpl.class);
