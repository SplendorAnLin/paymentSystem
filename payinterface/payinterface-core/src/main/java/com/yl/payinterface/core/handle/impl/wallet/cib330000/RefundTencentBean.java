 ...
 * @version V1.0.0
 */
public class RefundTencentBean {
	// 每个字段具体的意思请查看API文档
	 ...
	 */
	public RefundTencentBean(String appid, String mch_id, String transactionID, String outTradeNo, String deviceInfo, String outRefundNo, int totalFee,
		...
		// 随机字符串，不长于32 位
		setNonce_str(generateRandomStringByLength(32));
