package com.yl.payinterface.core.handle.impl.wallet.xkl350101.utils;
...
public class XklSignUtil {
    ...
    public static Map<String, String> httpGet(Map<String,String> request, String url) {
        ...
        try {
            par = HttpClientUtils.send(HttpClientUtils.Method.GET, url, (Map) null, false, "UTF-8", 300000);
