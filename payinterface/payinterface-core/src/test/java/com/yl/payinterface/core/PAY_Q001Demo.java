 ...
 * 测试商户号：3300065000000354
 * 
 * @author 聚合支付有限公司
 * @since 2016年11月27日
 * @version V1.0.0
 */
public class PAY_Q001Demo {
...
//		Configuration.loadConfiguation(Cmbc584002Constant.PAYMENT_PATH);
		...
		reqMap.put("merchantSeq", "3300065000000354201612339154547TD-594fdaac56af0000"); // 商户请求流水号
		...
		reqMap.put("orgMerchantSeq", "3300065000000354201612339154547TD-594fdaac56af0000"); // 原订单流水号
		reqMap.put("orgTransDate", "20161204"); // 原订单日期
		reqMap.put("defaultTradeType", "10030005"); // 10030001-即时网关支付,
													// 10030003-见证网关支付
