...
import com.yl.payinterface.front.utils.HFB100001.CertUtil;
import com.yl.payinterface.front.utils.HFB100001.ParamUtil;
 ...
 */
@Controller
@RequestMapping("/hfb100001Notify")
public class HFB100001CompleteController {

    private static final Logger logger = LoggerFactory.getLogger(HFB100001CompleteController.class);

    private static final String interfaceInfoCode = "HFB100001-QQ_SCAN";
    ...
    public void completeTrade(HttpServletRequest request, HttpServletResponse response){
        try {
            ...
            logger.info("合付宝 QQ扫码通知原文：{}", params);
