...
import com.yl.payinterface.front.utils.HFB100004.CertUtil;
import com.yl.payinterface.front.utils.HFB100004.ParamUtil;
 ...
 */
@Controller
@RequestMapping("/hfb100004Notify")
public class HFB100004CompleteController {
    
    private static final Logger logger = LoggerFactory.getLogger(HFB100004CompleteController.class);

    private static final String REMIT_INTERFACE_CODE = "HFB_100004_REMIT";
    ...
    public void completeRemit(HttpServletRequest request, HttpServletResponse response) {
        ...
        logger.info("合付宝 QQ扫码代付异步通知报文：{}", JsonUtils.toJsonString(params));
        try {
