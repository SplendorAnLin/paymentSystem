 ...
 * @version V1.0.0
 */
public class InternetbankSalesTradeBean implements Serializable {
	...
	/** 业务流水ID(业务系统每次交易的流水ID) add wcy 20140818 */
	...
	public String toString() {
		return "InternetbankSalesTradeBean [interfaceCode=" + interfaceCode + ", InterfaceProviderCode=" + InterfaceProviderCode + ", businessCode=" + businessCode
				...
				+ ", referer=" + referer + ", mobileInfoBean=" + mobileInfoBean + ", ownerRole=" + ownerRole + ", ownerID=" + ownerID + ", bussinessFlowID="
				+ bussinessFlowID + ", orderBackUrl=" + orderBackUrl + "]";
	}
