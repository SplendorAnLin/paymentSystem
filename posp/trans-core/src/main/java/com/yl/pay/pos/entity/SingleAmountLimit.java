...
@Entity
@Table(name = "SINGLE_AMOUNT_LIMIT")
public class SingleAmountLimit extends BaseEntity{
	...
	private String cardForm;							//E 卡形式
	private String entryCombine;						//条件组合类型 A|B|C|D|E
