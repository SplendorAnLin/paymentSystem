...
public class TransExceptionConstant {
	...
	public static final String POS_LOCATION_ERROR			= "000032";		//无线POS位置校验失败
	public static final String VOID_REVERSAL_AMOUNT_LIMIT   = "000033";		//撤销冲正类交易金额限制
	public static final String PRE_AUTH_COMP_AMOUNT_LIMIT   = "000034";		//预授权完成交易金额限制
	public static final String SHOPNO_NOT_RESET 			= "000035"; 	//商户编号点不一致需要重新签到
	public static final String TRANSTYPE_NOT_SUPPORT        = "000036";     //不支持的交易类型
	public static final String MAC_NOT_EMPTY                = "000037";     //MAC不能为空
	public static final String POS_NEED_RESIGNIN			= "000038";		//需要重新签到
	public static final String SOURCE_ORDER_DEBIT_FAIL 		= "000039";		//原订单出账失败
	public static final String CARD_AMOUNT_LIMIT    		= "000040";		//卡累计交易金额限制
	...
	public static final String POS_DEMOTION                 = "000045";		//Pos降级处理
	public static final String BLACK_LIST_CHECK             = "000046";		//交易黑名单校验
	public static final String DUPLICATE_POS_REQUEST        = "000050";		//POS请求重复
	public static final String MANDATORY_UPDATE 			= "000051";     //强制更新
	
	public static final String POS_LOCATION_PRO_ERROR		= "000052";		//无线POS位置校验失败(跨省)
	public static final String POS_LOCATION_LFB_ERROR		= "000053";		//无线POS位置校验失败(乐付宝移机，目前>)
	public static final String POS_TRACK2_ERROR				= "000054";		//二磁道为空
	...
	public static final String WILD_CARD					= "000113";		//外卡禁止交易
	public static final String GET_SYS_ROUTE_INFO_ERROR		= "000114";		//获取系统路由信息错误
	public static final String AMOUNT_OVER_ACCOUNT_BALANCE	= "000115";		//账户余额不足
	public static final String INTERFACE_CARD_BIN_PERMIT	= "000116";		//银行接口卡BIN限制
