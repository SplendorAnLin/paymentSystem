...
public class CmbcISO8583 {
	private static final Log log = LogFactory.getLog(CmbcISO8583.class);
...
//					}
	...
	public UnionPayBean Decoding(byte data[], int dataLen)
		...
		int charlen = 0;
		CmbcISO8583 ccbResponse = new CmbcISO8583(); 
		Field8583 ins = null;
...
//				value = new String(data, offset, domainLen);
	...
	public static void main(String[] args) throws Exception {
		...
		CmbcISO8583 ccb = new CmbcISO8583();
		try{
