...
public class Constant {
	...
	public static final String SEQ_SYSTEM_TRACKE_NUMBER = "SEQ_SYSTEMTRACKENUMBER_P500001";
	
	//frp code
	public static final String INTERFACE_CODE = "P500001";
	...
	public static final String ENTRY_MODE_071="071";//插卡带密码
	public static final String ENTRY_MODE_072="072";//插卡不带密码
	// 24域
	...
	public static final String NOMACTYPE_DOWNLOAD_MAIN_KEY="0700";//下载主密钥
...
//	public static final String TEST_BANK_POSCATI = "00000001";							//消费终端号
	public static final String TEST_BANK_CUSTOMERNO = "305440058131040";				//测试商户号	
	public static final String TEST_BANK_POSCATI = "10000042";							//消费终端号
}
