...
public class EsscUtils {
	...
	public static String createPosMac(String fullName,String makeMacString){
		...
		secretKey.setKeyName("pos.10121640.zak");
		secretKey.setKey("7C4313940EDFFDBA");
		secretKey.setCheckValue("B2FD697550D2B7D2");
		//String macKey = DesUtil.desDecrypt(secretKey.getKey(), "5EAE19A86AEA9E40");
		//log.info("+++++++++++++++++++++"+macKey);
