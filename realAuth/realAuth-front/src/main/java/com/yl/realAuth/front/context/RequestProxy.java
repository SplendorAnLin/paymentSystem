...
public class RequestProxy extends HttpServletRequestWrapper {
	...
	public RequestProxy(HttpServletRequest request) {
		...
		if (StringUtils.isNotBlank(request.getParameter(Constants.PARAM_NAME_INPUT_CHARSET))) {
			this.uri_encoding = request.getParameter(Constants.PARAM_NAME_INPUT_CHARSET);
		}
		if (StringUtils.isNotBlank(request.getParameter(Constants.PARAM_NAME_CHARSET))) {
			this.uri_encoding = request.getParameter(Constants.PARAM_NAME_CHARSET);
		}
	}
