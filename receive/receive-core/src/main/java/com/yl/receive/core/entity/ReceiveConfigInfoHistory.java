 ...
 * @version V1.0.0
 */
public class ReceiveConfigInfoHistory implements Serializable {
	...
	/** 单批次最大笔数 */
	private String singleBatchMaxNum;
	/** 单笔最大金额 */
	...
	public void setDailyMaxAmount(String dailyMaxAmount) {
		this.dailyMaxAmount = dailyMaxAmount;
	}

	public String getSingleBatchMaxNum() {
		return singleBatchMaxNum;
	}

	public void setSingleBatchMaxNum(String singleBatchMaxNum) {
...
//		return "ReceiveConfigInfo [id=" + id + ", ownerId=" + ownerId
//				+ ", dailyMaxAmount=" + dailyMaxAmount + ", singleBatchMaxNum="
//				+ singleBatchMaxNum + ", singleMaxAmount=" + singleMaxAmount
//				+ ", privateCer=" + privateCer + ", publicCer=" + publicCer
//				+ ", isCheckContract=" + isCheckContract + ", createTime="
//				+ createTime + ", lastUpdateTime=" + lastUpdateTime
//				+ ", status=" + status + ", remark=" + remark + ", version="
//				+ version + ", custIp=" + custIp + ", domain=" + domain + "]";
//	}
