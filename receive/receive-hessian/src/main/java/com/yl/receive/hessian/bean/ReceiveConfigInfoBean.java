 ...
 * @version V1.0.0
 */
public class ReceiveConfigInfoBean implements Serializable {
	...
	public String toString() {
		return "ReceiveConfigInfoBean [ownerId=" + ownerId + ", dailyMaxAmount=" + dailyMaxAmount + ", singleBatchMaxNum=" + singleBatchMaxNum + ", singleMaxAmount=" + singleMaxAmount + ", privateCer=" + privateCer + ", publicCer=" + publicCer + ", isCheckContract=" + isCheckContract
