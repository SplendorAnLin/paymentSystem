...
<html>
	...
	<!--	<div class="back"><a>返回</a> </div>-->
		...
		<div class="container bg_white" >
			<p>收款金额</p>
			<p class="setmoney">￥
				<input class="ipt" type="tel" autofocus="autofocus" maxlength="5" onKeyPress="if((event.keyCode<48 || event.keyCode>57) && event.keyCode!=46 || /\.\d\d$/.test(value))event.returnValue=false;" />
			</p>
			<p class="f-gray">金额必须大于0，小于100000（十万）</p>
