	...
	<body>
			...
			<div class="page__bd" style="height: 100%;">
				<div class="weui-tab">
					...
					<div class="weui-tabbar">
						...
						<a href="toMyCenter" class="weui-tabbar__item" target="myIframe" data-id="2">
		...
		<script type="text/javascript">
			$(function() {
				...
				imglistok[2] = "${pageContext.request.contextPath}/image/public/icon/person.png";
				...
				imglistno[2] = "${pageContext.request.contextPath}/image/public/icon/person_gray.png";
			  ...
			  {
                  $(".weui-tabbar__item").eq(2).find("img").attr("src", imglistok[0]);
                  $(".weui-tabbar__item").eq(2).css("color", "#1B82D2");
